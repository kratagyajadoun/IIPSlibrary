...
try
{
     ...
     System.out.println("driver register");
      ...
      PreparedStatement ps=con.prepareStatement("select * from book where subject=? ");
      ...
      <h2>Showing results for subject <%out.print(""+subject); %></h2>
      <h4>Click on book name to see user details</h4>
      <div class="table">
      ...
      <table class="table">      
      <tr>
    	 <td><a href=<%= "\"userview.jsp?Id=" + rs.getString(1) + "\"" %> ><%out.print(""+rs.getString(3)+"<br>");%></a></td>
